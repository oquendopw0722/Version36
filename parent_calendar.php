    ...
    <div class="Home_content">
      <div class="main-content">
        ...
        <section class="announcement">
            <ul>
                <li><strong>October 25:</strong> Parent-Teacher Meeting</li>
                <li><strong>November 2:</strong> Report Card Release</li>
                <li><strong>December 15:</strong> Recognition Day</li>
                <li><strong>December 20:</strong> Start of Christmas Break</li>
            </ul>
        </section>
